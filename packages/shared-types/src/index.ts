...
export const OUTBOX_EVENT_TYPES = {
  ...
  MEMBERSHIP_UNSUSPENDED: "MEMBERSHIP_UNSUSPENDED",
  MEMBERSHIP_REINSTATED: "MEMBERSHIP_REINSTATED",
  MEMBERSHIP_UNSUSPEND_REQUESTED: "MEMBERSHIP_UNSUSPEND_REQUESTED",
  ...
  ACCESS_OVERRIDE_CREATED: "ACCESS_OVERRIDE_CREATED",
  ACCESS_OVERRIDE_UPDATED: "ACCESS_OVERRIDE_UPDATED",
  ACCESS_OVERRIDE_REVOKED: "ACCESS_OVERRIDE_REVOKED",
  MEMBER_ATTENDED: "MEMBER_ATTENDED",
  EVENT_CREATED: "EVENT_CREATED",
  EVENT_UPDATED: "EVENT_UPDATED",
  EVENT_DELETED: "EVENT_DELETED",
  EVENT_ATTENDANCE_RECORDED: "EVENT_ATTENDANCE_RECORDED",
  BADGE_ASSIGNED: "BADGE_ASSIGNED",
  BADGE_REVOKED: "BADGE_REVOKED",
  CONTRIBUTION_SCORE_UPDATED: "CONTRIBUTION_SCORE_UPDATED",
  CONSTITUTIONAL_RULESET_CREATED: "CONSTITUTIONAL_RULESET_CREATED",
  CONTRACT_ADMIN_UPDATED: "CONTRACT_ADMIN_UPDATED",
  CONTRACT_OWNERSHIP_TRANSFERRED: "CONTRACT_OWNERSHIP_TRANSFERRED",
} as const;

export type OutboxEventType =
  (typeof OUTBOX_EVENT_TYPES)[keyof typeof OUTBOX_EVENT_TYPES];

export const OUTBOX_EVENT_TYPE_VALUES = Object.values(OUTBOX_EVENT_TYPES);
